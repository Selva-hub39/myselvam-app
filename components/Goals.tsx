...
import type { Goal, LinkedInvestment } from '../types';
import Card from './common/Card';
import { PlusIcon, EditIcon, TrashIcon } from './common/Icons';
import { calculateFutureValueSIP, calculateFutureValueLumpSum } from '../utils/finance';
...
const GoalForm: React.FC<{ 
    ...
    const [linkedInvestments, setLinkedInvestments] = useState<LinkedInvestment[]>(existingGoal?.linkedInvestments || [{ schemeName: '', sipAmount: 0, lumpsumInvestment: 0 }]);

    const handleInvestmentChange = (index: number, field: keyof LinkedInvestment, value: string) => {
