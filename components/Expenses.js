...
import { PlusIcon, TrashIcon, YearIcon } from './common/Icons.js';
import { ResponsiveContainer, PieChart, Pie, Cell, Tooltip, Legend } from 'recharts';


// --- Helper Components ---

const YTD_Summary_Modal = ({
    expenses,
    onClose
}) => {
...
const BudgetEditModal = ({
    ...
    const handleBudgetAmountChange = (index, amount) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const finalBudgets = localBudgets
...
const QuickAddExpense = ({ categories, onAdd }) => {
...
const Expenses = ({ expenses, setExpenses, budgets, setBudgets }) => {
    ...
    const handleSaveBudgets = (updatedBudgets, renames) => {
